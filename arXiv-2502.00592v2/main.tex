...
\icmlauthor{Dmitry Krotov}{mitibm,ibm}
\icmlauthor{Yuanzhe Hu}{ucsd}
\icmlauthor{Yifan Gao}{amazon}
\icmlauthor{Wangchunshu Zhou}{oppo}
\icmlauthor{Julian McAuley}{ucsd}
\icmlauthor{Dan Gutfreund}{mitibm,ibm}
\icmlauthor{Rogerio Feris}{mitibm,ibm}
\icmlauthor{Zexue He}{ucsd,mitibm,ibm}
\end{icmlauthorlist}

\icmlaffiliation{ucsd}{UC, San Diego}
\icmlaffiliation{mitibm}{MIT-IBM Waston Lab}
...
\icmlcorrespondingauthor{Zexue He}{Zexue.He@ibm.com}
...
\printAffiliationsAndNotice{Work done during the internship at MIT-IBM Waston Lab.}  % leave blank if no need to mention equal contribution
